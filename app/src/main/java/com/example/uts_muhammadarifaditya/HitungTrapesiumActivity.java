...
import com.example.uts_muhammadarifaditya.BangunDatar.Trapesium.KelilingTrapesium;
import com.example.uts_muhammadarifaditya.BangunDatar.Trapesium.LuasTrapesium;
...
//                txtHasil.setText(String.valueOf("Hasil :\nLuas = " + luasTrapesium.hitung_luas()));
                ...
                Intent i = new Intent(HitungTrapesiumActivity.this, HasilActivity.class);
                i.putExtra(KEY_JUDUL, ("LUAS "+TAB));
                i.putExtra(KEY_HASIL, (String.valueOf(luasTrapesium.hitung_luas())));
                i.putExtra(KEY_FOTO, ("@drawable/trapesium"));
                startActivity(i);
...
//                txtHasil.setText(String.valueOf("Hasil :\nKeliling = " + kelilingTrapesium.hitung_keliling()));
                ...
                i.putExtra(KEY_HASIL, (String.valueOf(kelilingTrapesium.hitung_keliling())));
                i.putExtra(KEY_FOTO, ("@drawable/trapesium"));
                startActivity(i);
