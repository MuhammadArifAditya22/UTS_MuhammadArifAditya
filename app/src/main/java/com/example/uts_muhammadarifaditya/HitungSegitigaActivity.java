...
import com.example.uts_muhammadarifaditya.BangunDatar.Segitiga.KelilingSegitiga;
import com.example.uts_muhammadarifaditya.BangunDatar.Segitiga.LuasSegitiga;
...
//                txtHasil.setText(String.valueOf("Hasil :\nLuas = " + luasSegitiga.hitung_luas()));
                ...
                Intent i = new Intent(HitungSegitigaActivity.this, HasilActivity.class);
                i.putExtra(KEY_JUDUL, ("LUAS SEGITIGA"));
                i.putExtra(KEY_HASIL, (String.valueOf(luasSegitiga.hitung_luas())));
                i.putExtra(KEY_FOTO, ("@drawable/segitiga"));
                startActivity(i);
...
//                txtHasil.setText(String.valueOf("Hasil :\nKeliling = " + kelilingSegitiga.hitung_keliling()));
                ...
                Intent i = new Intent(HitungSegitigaActivity.this, HasilActivity.class);
                i.putExtra(KEY_JUDUL, ("Keliling Segitiga"));
                i.putExtra(KEY_HASIL, (String.valueOf(kelilingSegitiga.hitung_keliling())));
                i.putExtra(KEY_FOTO, ("@drawable/segitiga"));
                startActivity(i);
